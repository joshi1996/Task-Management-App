...
class TaskRemoteRepository {
  ...
  Future<bool> syncTasks({
    ...
    try {
      ...
      debugPrint("SYNCING TASKS :: ${taskListInMap.toString()}");
      ...
      debugPrint("SYNC RESPONSE1 :: ${res.body.toString()}");
      debugPrint("SYNC RESPONSE2 :: ${res.toString()}");
      debugPrint("SYNC RESPONSE3 :: ${res.headers.toString()}");
